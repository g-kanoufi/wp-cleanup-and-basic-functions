...
<div id="images-settings" class="wrap metabox-holder columns-2 wp_cbf-metaboxes hide">

	<h2><?php esc_attr_e( 'Images specific functionalities', $this->plugin_name ); ?></h2>
	<p>Clean up images and captions markup but also add images sizes and create retina ready images on upload</p>
	...
	<fieldset>
		...
		<label for="<?php echo $this->options_slug;?>-images_figure_wrap">
			<input type="checkbox" id="<?php echo $this->options_slug;?>-images_figure_wrap" name="<?php echo $this->options_slug;?>[images_figure_wrap]" value="1" <?php if($images_figure_wrap == '1') echo 'checked';?>/>
	...
	<fieldset>
		...
		<label for="<?php echo $this->options_slug;?>-inline_wp_caption">
			<input type="checkbox" id="<?php echo $this->options_slug;?>-inline_wp_caption" name="<?php echo $this->options_slug;?>[inline_wp_caption]" value="1" <?php if($inline_wp_caption == '1') echo 'checked';?>/>
	...
	<fieldset>
		...
		<label for="<?php echo $this->options_slug;?>-images_attributes">
			<input type="checkbox" id="<?php echo $this->options_slug;?>-images_attributes" name="<?php echo $this->options_slug;?>[images_attributes]" value="1" <?php if($images_attributes == '1') echo 'checked';?>/>
	...
	<fieldset>
		...
		<label for="<?php echo $this->options_slug;?>-images_wh">
			<input type="checkbox" id="<?php echo $this->options_slug;?>-images_wh" name="<?php echo $this->options_slug;?>[images_wh]" value="1" <?php if($images_wh == '1') echo 'checked';?>/>
	...
	<fieldset>
		...
		<label for="<?php echo $this->options_slug;?>-retina_support">
	...
	<fieldset>
		...
		<label for="<?php echo $this->options_slug;?>-new_images_size">
		...
		<fieldset class="new-images-size <?php if($new_images_size != '1') echo 'hide'; ?>">
			...
			<br/>
			<label for="t<?php echo $this->options_slug;?>-new_images_size_w">Width</label>
			<input name="<?php echo $this->options_slug;?>[images_size][width]" type="number" step="1" min="0" id="<?php echo $this->options_slug;?>-new_images_size_w" placeholder="500" class="small-text">
			<label for="<?php echo $this->options_slug;?>-new_images_size_h">Height</label>
			<input name="<?php echo $this->options_slug;?>[images_size][height]" type="number" step="1" min="0" id="<?php echo $this->options_slug;?>-new_images_size_h" placeholder="300"  class="small-text">
			<br>
			<label for="<?php echo $this->options_slug;?>-new_images_size_crop">
				<input name="<?php echo $this->options_slug;?>[images_size][crop]" type="checkbox" id="<?php echo $this->options_slug;?>-new_images_size_crop">
		...
		<fieldset class="existing-images-size-container <?php if($new_images_size_position < 2) echo 'hide'; ?>">
			<h3>Already Existing Images sizes</h3>
				...
				<fieldset class="existing-images-size">
					...
					<label for="<?php echo $this->options_slug;?>-<?php echo $existing_images_size_name;?>_w">Width</label>
					<input name="<?php echo $this->options_slug;?>[existing_images_size][<?php echo $existing_images_size_name;?>][name]"
						type="hidden"
						value="<?php echo $existing_images_size_values['name'];?>"
					>
					<input name="<?php echo $this->options_slug;?>[existing_images_size][<?php echo $existing_images_size_name;?>][width]"
					            type="number"
					            step="1"
					            min="0"
					            id="<?php echo $this->options_slug;?>-<?php echo $existing_images_size_name;?>_w"
					            value="<?php echo $existing_images_size_values['width'];?>"
					            class="small-text"
					>
					<label for="<?php echo $this->options_slug;?>-<?php echo $existing_images_size_name;?>_h">Height</label>
					<input name="<?php echo $this->options_slug;?>[existing_images_size][<?php echo $existing_images_size_name;?>][height]"
						type="number"
						step="1"
						min="0"
						id="<?php echo $this->options_slug;?>-<?php echo $existing_images_size_name;?>_h"
						value="<?php echo $existing_images_size_values['height'];?>"
						class="small-text">
					<br>
					<label for="<?php echo $this->options_slug;?>-<?php echo $existing_images_size_name;?>_crop">
						<input name="<?php echo $this->options_slug;?>[existing_images_size][<?php echo $existing_images_size_name;?>][crop]"
						type="checkbox"
						id="<?php echo $this->options_slug;?>-<?php echo $existing_images_size_name;?>_crop"
						<?php if($existing_images_size_values['crop']) echo 'checked';?> >
						<span><?php esc_attr_e('Crop thumbnail to exact dimensions (normally thumbnails are proportional)',  $this->plugin_name);?></span>
					</label>
				</fieldset>
				<?php endif;?>
	...
	<fieldset>
		...
		<select name="<?php echo $this->options_slug;?>[gallery_images_size]">
			<option value="null" <?php if($gallery_images_size == null) echo 'selected';?>>Default (none)</option>
            ...
            ?>
			<option value="<?php echo $_size;?>" <?php if($gallery_images_size == $_size) echo 'selected';?>><?php echo $_size;?> - <?php echo $sizes[$_size]['width'];?>x<?php echo $sizes[$_size]['height'];?></option>
			<?php endforeach;?>
		</select>
	</fieldset>
</div>
